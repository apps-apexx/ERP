                                            ...
                                            <div class="dropdown-menu dash-h-dropdown dropdown-menu-end"
                                                ...
                                                @foreach ($currantLang as $offerlangs)
                                                    <a href="{{ route('get.offerlatter.language',['noclangs'=>$noclang, 'explangs'=>$explang, 'offerlangs'=>$offerlangs, 'joininglangs'=>$joininglang ]) }}"
                                                       class="dropdown-item ms-1 {{ $offerlangs == $offerlang ? 'text-primary' : '' }}">{{ Str::upper($offerlangs) }}
                                                    </a>
                                                @endforeach
                                            </div>
                                        </li>
...
{{--                                    <div class="mt-0">--}}
{{--                                        <a href="#" data-size="md" class="btn  btn-primary " data-ajax-popup-over="true" data-url="{{ route('generate',['offer letter']) }}"--}}
...
{{--                                    <div class="mt-0">--}}
{{--                                        <a href="#" data-size="md" class="btn  btn-primary " data-ajax-popup-over="true" data-url="{{ route('generate',['joining letter']) }}"--}}
{{--                                           data-bs-placement="top" data-title="{{ __('Generate content with AI') }}">--}}
{{--                                            <i class="fas fa-robot"></i> <span>{{__('Generate with AI')}}</span>--}}
{{--                                        </a>--}}
{{--                                    </div>--}}
...
{{--                                    <div class="mt-0">--}}
{{--                                        <a href="#" data-size="md" class="btn  btn-primary " data-ajax-popup-over="true" data-url="{{ route('generate',['experience letter']) }}"--}}
{{--                                           data-bs-placement="top" data-title="{{ __('Generate content with AI') }}">--}}
{{--                                            <i class="fas fa-robot"></i> <span>{{__('Generate with AI')}}</span>--}}
{{--                                        </a>--}}
{{--                                    </div>--}}
...
{{--                                    <div class="mt-0">--}}
{{--                                        <a href="#" data-size="md" class="btn  btn-primary " data-ajax-popup-over="true" data-url="{{ route('generate',['noc letter']) }}"--}}
{{--                                           data-bs-placement="top" data-title="{{ __('Generate content with AI') }}">--}}
{{--                                            <i class="fas fa-robot"></i> <span>{{__('Generate with AI')}}</span>--}}
{{--                                        </a>--}}
{{--                                    </div>--}}
